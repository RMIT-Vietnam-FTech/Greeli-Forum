...
export default function Main() {
    ...
    <>
      <main className="bg-light-subtle">
          ...
          <div className="container mt-5 mx-auto">
            <div className="text-center px-4">
              ...
              <p className="col-lg-8 mx-auto fs-5 pb-5">
                ...
                voluptate odit, placeat illo, sunt unde nulla? Lorem ipsum dolor
                sit amet, consectetur adipisicing elit. Alias voluptatum minus
                fugiat tempora, natus corrupti. Soluta incidunt aut officiis
                adipisci earum impedit minima itaque quod non voluptatibus, modi
                tempora beatae?
              </p>
        ...
        {/* Feature Section */}
        <section className="p-4 bg-primary-green mx-5 rounded-5 " id="features">
