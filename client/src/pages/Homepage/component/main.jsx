    ...
    >
      ...
      <section className="mx-md-5 mx-4 mb-md-5 mb-3 bg-greeli-subtle rounded-5 section">
        <div className="col-12 p-5 mx-auto text-center">
          <h1 className="display-3 text-greeli-emphasis mb-3 mb-md-4">
          ...
          <Link to="/about" className="d-inline-flex">
            <button
              className="text-center text-white btn btn-lg theme-button bg-primary-green-700 m-3 px-5 py-2 rounded-pill fw-bold"
              type="button"
            >
              Read more
            </button>
      ...
      <section className="mx-md-5 mx-4 p-4 my-md-5 my-3 bg-primary-green rounded-5 section">
        ...
        <div className="container d-flex flex-column flex-md-row p-0 m-auto">
          <div className="p-3 p-md-5 w-60 w-md-100 text-center solution-item">
      ...
      <section className="mx-md-5 mx-4 p-4 bg-greeli-subtle rounded-5 section">
        <h2 className="d-block fw-bold text-center text-greeli-emphasis w-100 mb-3 mb-md-4">
          Recommend Post
        </h2>
        <Posts />
        <Link to="/forum" className="d-block text-center mt-2">
          <button
            className="text-white btn btn-lg theme-button bg-primary-green-700 m-3 px-5 py-2 rounded-pill fw-bold"
            type="button"
          >
            Read more
          </button>
