      ...
      <section className="mx-md-5 mx-4 mb-md-5 mb-3 bg-greeli-subtle rounded-5 section introduction">
        <div className="col-12 pt-5 pb-4 mx-auto text-center">
          ...
          <p className="fs-5 text-greeli-emphasis text-center mb-3 p-3">
            Greeli is your gateway to a greener tomorrow! We're more than
            information - we're a vibrant community passionate about sustainable
            living. At Greeli, you'll find a treasure trove of resources to
            jumpstart or elevate your eco-journey, no matter your experience
            level. We offer practical guides, inspiring stories, and expert
            advice to empower you to make eco-conscious choices for your home,
            health, and the planet. Join us as we explore ways to conserve
            resources, embrace renewable energy, and minimize waste. Discover
            the joy of local living, sustainable fashion, and creating a haven
            for nature in your own backyard. Greeli is your one-stop shop for
