...
export default function Weather() {
    ...
    return (
        <div className="weather-container bg-greeli-subtle"
            data-bs-theme={isDarkMode ? "dark" : "light"}>
            <h4 className="weatherForecast text-general-emphasis">
                WEATHER FORECAST
            </h4>
            <div className={`mx-auto rounded text-center p-4 weather-body ${isDarkMode ? "dark-mode-body" : "light-mode-body"}`}>

                <Toaster position="bottom-right" reverseOrder={false} />
                <form className="d-flex mb-5" onSubmit={handleSubmit}>
                    <input className={`form-control me-2 ${isDarkMode ? "dark-mode-input" : "light-mode-input"}`} placeholder="City" name="city" />
                    <button className="btn btn-outline-light" type="submit">Search</button>
                </form>

                {loading ? (
                    <div className={`loading ${isDarkMode ? "dark-mode-loading" : "light-mode-loading"}`}>
                        <p>Loading...</p>
                    </div>
                ) : error ? (
                    <div className={`error ${isDarkMode ? "dark-mode-error" : "light-mode-error"}`}>
                        <p>No city found. <br /> Please make sure you entered a valid city name and try again.</p>
                    </div>
                ) : (
                    <div className="weather-content">
                        <div className={`current-weather ${isDarkMode ? "dark-mode-content" : "light-mode-content"}`}>
                        ...
                        <div className={`weather-details ${isDarkMode ? "dark-mode-details" : "light-mode-details"}`}>
                            <div>
                        ...
                        <div className={`forecast ${isDarkMode ? "dark-mode-forecast" : "light-mode-forecast"}`}>
