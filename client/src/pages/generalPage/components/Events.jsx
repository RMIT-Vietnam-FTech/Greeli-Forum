...
export default function Events() {
    ...
    const filteredData = category === 'Social activities' ? EventsData : EventsData.filter(item => item.event === category);
        ...
        <>
            <section className="news">
                ...
                <ul className="nav nav-pills events_selection">
                    ...
                    <li className="nav-item" onClick={() => setCategory('Social events')}>
                        <h4>Social events</h4>
                    </li>
                </ul>
