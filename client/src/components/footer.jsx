				...
				<div className="container">
					<div className="row justify-content-between gx-5">
						...
						<div className="col-3 mt-3 mb-2">
							...
							<p className="text-light">
								...
								adipisicing elit. Repellendus itaque earum,
								laudantium fugiat officiis odit ullam aut
								delectus ea magnam.
							</p>
							<img
								src="logo.svg"
					...
					<div className="d-flex justify-content-center border-top">
						<div class="text-light py-3">
							Copyright ©2024 All rights reserved | This website
							is designed and built by{" "}
							<span class="text-yellow-500">RMIT FTech Team</span>
						</div>
					</div>
				</div>
			</footer>
