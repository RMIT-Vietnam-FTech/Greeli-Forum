...
export default function LoginPopup({ isShow }) {
  ...
  return (
    <div data-bs-theme={isDarkMode ? "dark" : "light"}>
            ...
            <div className="modal-body">
              ...
              >
                ...
                >
                  ...
                  <div className="form-floating" role="textbox">
                    <input
                      name="email"
                      type="text"
                      {...register("email")}
                    ...
                    />
                    <label for="floatingInput" className="text-greeli-emphasis">
                      Email address
                    </label>
                  </div>
                </div>
      ...
      {/* Dark overlay */}
      {popupContext.isPopup && <div className="modal-backdrop fade show" />}
    </div>
  );
}
