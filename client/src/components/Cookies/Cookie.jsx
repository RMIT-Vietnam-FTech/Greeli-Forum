    ...
    >
      <div className="cookies-content">
        ...
        <p className="text-primary-green d-block m-0">
          ...
          These cookies store information about your preferences and help us
          analyze website traffic. By continuing to use our site, you consent to
          our use of cookies. To learn more about the cookies we use and how to
