...
export const archiveComment = async (req, res) => {
  try {
    ...
    comment.archived.archivedBy.userId = user._id;
    (comment.archived.archivedBy.username = user.username),
      (comment.archived.archivedBy.profileImage = user.profileImage),
      await comment.save();
